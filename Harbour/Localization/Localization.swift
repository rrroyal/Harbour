...
enum Localization: String {
	...
	case SETTINGS_USE_COLORED_CONTAINER_CELLS_TITLE = "%SETTINGS_USE_COLORED_CONTAINER_CELLS_TITLE%"
	case SETTINGS_USE_COLORED_CONTAINER_CELLS_DESCRIPTION = "%SETTINGS_USE_COLORED_CONTAINER_CELLS_DESCRIPTION%"
